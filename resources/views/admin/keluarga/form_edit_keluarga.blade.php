...
@section('title', 'Form Edit Keluarga')
@section('content')
<div class="app-content-header">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Form Edit Keluarga</h3>
            </div>
        </div>
        <!--end::Row-->
    </div>
...
<div class="app-content">
    <div class="container-fluid">
        <div class="card card-success card-outline mb-4">
            ...
            <form action="{{ route('keluarga.updateKeluargaByNoKK', $keluargas->no_kk) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="desa_kelurahan"
                            ...
                            value="{{ $keluargas->desa_kelurahan }}"/>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kabupaten_kota"
                            ...
                            value="{{ $keluargas->kabupaten_kota }}"/>
                    </div>
                    <div class="mb-3">
